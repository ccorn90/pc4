...
% try a random move but check for follow-up threats
weightedAI(_,_,G,T,M) :-
      randomMoveAI(G,T,M).

% find any move without follow-up threats
weightedAI(_,_,G,_,M) :-
      validMove(G,M),
      \+ hasFollowUpThreat(G,M).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% mainLoop/3 -- the main loop in our program
